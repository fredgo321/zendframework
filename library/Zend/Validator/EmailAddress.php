...
class EmailAddress extends AbstractValidator
{
    ...
    protected function idnToAscii($email)
    {
	    ...
	    //return (idn_to_ascii($email,INTL_IDNA_VARIANT_UTS46,INTL_IDNA_VARIANT_UTS46) ?: $email);
        }
        return $email;
    }
    ...
    protected function idnToUtf8($email)
    {
		...
		if (defined('INTL_IDNA_VARIANT_UTS46')) {
        	...
        	//return idn_to_utf8($email,INTL_IDNA_VARIANT_UTS46,INTL_IDNA_VARIANT_UTS46);
        }
        return $email;
    }
}
